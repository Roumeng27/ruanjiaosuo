<template>
    <div class="newBox">
      <!-- 邀请函 -->
        <div v-show="passJudgeShow" class="pageCase">
                        ...
                        <el-collapse-item title="邀请函信息" name="2">
                            <div class="edit_list">
                                ...
                                <div class="editItem">
                                    ...
                                    <div class="editCenter">
                                        <div class="editTit" style="width:40px;">上午：</div>
                                        <div class="editContent">
                                            <el-time-select
                                                placeholder="开始时间"
                                ...
                                <div class="editItem">
                                    <div class="editTextarea">
                                        <div class="editName" style="width:200px !important;">采购文件工本费接收账户：</div>
                                        <div class="editContent">
                ...
                <div class="main_info">
                    <el-collapse v-model="activeName1" accordion>
                        ...
                        <el-collapse-item title="邀请单位信息" name="3" v-show="inviteFlag">
                            ...
                            <div style="margin-top:15px;" v-show="invite_show_flag">
                                <el-table :data="unitInformateData" stripe style="width: 100%"  @selection-change="handleFileChange">
                                    ...
                                    <el-table-column prop="invitationTime" :show-overflow-tooltip ="true" label="发出时间">
                                    </el-table-column>
                                    <el-table-column prop="isPayTenderFee" :show-overflow-tooltip ="true" label="支付标书费">
                                    </el-table-column>
                                    <el-table-column prop="isPayDeposit" :show-overflow-tooltip ="true" label="缴纳保证金">
                                    </el-table-column>
                                    <el-table-column prop="invitationStatus" :show-overflow-tooltip ="true" label="邀请函状态">
                                    </el-table-column>
                            ...
                            <div style="margin-top:15px;" v-show="!invite_show_flag">
                                <el-table :data="unitInformateData" stripe style="width: 100%"  @selection-change="handleFileChange">
                                    ...
                                    <el-table-column prop="operation" label="查看">
                                        <template slot-scope="scope">
                                            <i class="el-icon-search" style="cursor:pointer;" @click="lookSendFile(scope.row)"></i>
                                        </template>
                                    </el-table-column>
            ...
            <div class="lookWrapper" v-show="lookUnitShow">
                <div class="lookBox">
                    ...
                    <div class="main_info">
                        <el-collapse v-model="activeName2" accordion>
                            <!-- 采购项目信息 -->
                            <el-collapse-item title="采购项目信息" name="3">
                                <div class="edit_list">
                                    <div class="editItem">
                                        <div class="editCenter">
                                            <div class="editName">采购项目名称：</div>
                            ...
                            <!-- 投标邀请 -->
                            <el-collapse-item title="投标邀请" name="4">
                                <div class="edit_list">
                                    <div class="editItem">
                                        <div class="editCenter">
                                            <div class="editName">企业资质要求：</div>
                    ...
                    <div class="main_info">
                        <div>
                            <el-table :data="chooseData" style="width: 100%" >
                                ...
                                <el-table-column  prop="isStartUsing" :show-overflow-tooltip ="true" label="单位状态">
                                </el-table-column>
  ...
  methods:{
        checkMoney(){
            if(!checkNumber(this.costBiddingDocuments)){
                this.$message.warning('工本费请输入数字类型');
            }
        },
        getisPayTenderFee(){
    ...
                }  
        ...
        saveInfo(num){
            ...
            this.$axios({
                ...
                if(res.data.status == 200){
                    ...
                    this.biddersRequiredSubmitInformation  = res.data.data.biddersRequiredSubmitInformation; // 投标人需提交资料
                    this.contactInformation  = res.data.data.contactInformation;// 采购项目信息联系方式
                    this.contactMode = res.data.data.contactMode;// 邀请函信息联系方式
                    this.costBiddingDocuments = res.data.data.costBiddingDocuments;// 采购文件工本费(
                    this.costBiddingDocumentsAccount = res.data.data.costBiddingDocumentsAccount;// 采购文件工本费接收账户
                    this.certificateBox = JSON.parse(res.data.data.enterpriseQualification);// 企业资质要求
                    if(this.certificateBox.length>0){
                        this.certificateBox = dubRemove(this.certificateBox);
                        let arr = [];
                    ...
                    this.afterbegin = this.saleTimeAfternoon[0];
                    this.afterend = this.saleTimeAfternoon[1];
                    this.venueBiddingDocuments= res.data.data.venueBiddingDocuments;// 采购文件发售地点
                    if(num== 1){
                        this.saveBox = true;
                    }else{
                        this.saveBox = false;
        ...
        addNewCompany(){
            ...
            if(this.companyName == ""){
                ...
                this.$message.warning('请输入投标回执截至时间！');
                return false;
                ...
                if(this.unitInformateData.length == 0){
                    ...
                    this.unitInformateData.forEach(item=>{
                        if(this.bidCompany == item.bidCompany){
                            this.$message.warning('不能添加相同id的单位名称');
                            flag = false;
                        }
                    }) 
                    if(flag){
        ...
        sendInvite(){
            if(this.bidInforId.length == 0){
                this.$message.warning('未选择可发出的数据');
                return false;
            }else {
                if(this.invitaStr == '已发出'){
                    this.$message.warning('不能再次发出邀请函');
                    return false;
                }else{
                    this.inviteBox = true;
                }
