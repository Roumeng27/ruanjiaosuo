    ...
    export default {
        data(){
            return {
                ...
                saveBox:false,//保存弹窗
                // 采购信息 下边的分包信息(总包不显示 分包显示)
                breakBagFlag:false,
                tenderData:[],//供应商信息数据列表
            ...
            getbiddingInfo(){
                this.$axios({
                    ...
                    if(res.data.status == 200){
                        ...
                        this.biddingProcurementMode = res.data.data.biddingProcurementMode;// 采购方式
