            ...
            <div class="nextWrapper" v-show="nextFlag" style="overflow-y:hidden;height:100%;">
                ...
                <div style="overflow-y:scroll;height:100%;">
                    <el-collapse v-model="activeName1" accordion>
                        ...
                        <!-- 附件 -->
                        <el-collapse-item title="附件" name="2" v-show="orderFlag">
                        ...
                        <el-collapse-item title="公告内容" name="5">
                            <div class="edit_list">
                                ...
                                <div class="editItem">
                                    <div class="editCenter">
                                        <div class="editName" style="font-weight:bold;">采购文件发售时间</div>
                                        <div class="editContent">
                                ...
                                <div class="editItem">
                                    <div class="editCenter">
                                        <div class="editName">采购文件工本费：</div>
                                        <div class="editContent">{{tenderDocumentsCost}}元</div>
                                    </div>
                                </div>
                                <div class="editItem">
                                    <div class="editCenter">
        ...
        methods:{
            ...
            newly(num){
                ...
                if(!this.noticeName) {
                    ...
                    this.$message.warning('采购数量请输入数字类型！');
                    return false;
                }else{
                    if(num == 1){
                        this.areaList = [];
                ...
                if(this.projectObj.totalProjectId.indexOf("-") != -1&& this.projectObj.totalProjectId!=null){ 
                    ...
                    if(this.initList.length != 0){
                        objectData={
                            ...
                            agentPhone :this.agentPhone ,agentAddress :this.agentAddress ,
                            items:this.areaList
                        }
                    }else{
                        objectData={
                            ...
                            //如果上一步打钩，进一步判断
                                ...
                                if(obj.zhaobiao.state == '办理通过'&& obj.houxuanren.state == '办理通过'){
                                    ...
                                    if(obj.zhaobiao.state == '办理通过'){
                                        ...
                                        this.alertMsg = '尚未完成场地预约,无法进行采购公告!'
                                    }
                                }
                            }else{
                                //其他的都不能看
