                                ...
                                <div class="edit_list">
                                    ...
                                    <div class="editItem">
                                        ...
                                        <div class="editCenter">
                                            ...
                                            <div class="editContent">{{subcontractingControlAmount == null ? budgetAmount : subcontractingControlAmount}}万元</div>
                                        </div>
                                    </div>
                                    <div class="editItem">
                                        <div class="editCenter">
...
export default {
    data(){
        return {
            ...
            technologyQualifications:'',// 简要规格描述或项目基本情况
    ...
    methods:{
                        ...
                        //如果上一步打钩，进一步判断
                            ...
                            if(obj.zhaobiao.state == '办理通过'&& obj.toubiao.state == '办理通过'){
                                ...
                                if(obj.zhaobiao.state == '办理通过'){
                                    ...
                                    this.alertMsg = '尚未完成采购公告,无法进行投标报名!'
                                }
                            }
                        }else{
                            //其他的都不能看
        ...
        async editInfo(row){
            ...
            if(row.payDepositTime == 0 || row.payDepositTime == null){
                this.payDepositTime = '';
            }else{
            ...
            this.getOneList();// 投标保证金缴纳凭证附件附件
            this.getTwoList();//其他材料
        ...
        //投标单位列表 保存
        saveEdit(){
            if(this.payDepositAmount =='' || this.payDepositAmount == 0 || this.payDepositAmount ==null){
            ...
            if(this.payDepositAmount !='' &&this.payDepositAmount !=null && this.checkMoney(this.payDepositAmount)){
                ...
                this.$axios({
                    method: "POST",
                    url: baseUrl+"/bidInforController/updatePay",
                    data:{
        ...
        async lookItem(row){
           ...
           // 标书费缴纳记录
            ...
            if(row.payTenderFeeTime == 0 || row.payTenderFeeTime == null){
                ...
                this.payTenderFeeTime = dayjs(row.payTenderFeeTime).format('YYYY-MM-DD HH:mm:ss');// 支付时间
            }
            this.payTenderFeeAmount = row.payTenderFeeAmount;//支付金额
            if(row.isPayTenderFee =='已支付'){
                this.isPayTenderFee = '是'
            ...
            if(row.payDepositTime == 0 || row.payDepositTime == null){
                ...
                this.payDepositTime = dayjs(row.payDepositTime).format('YYYY-MM-DD HH:mm:ss');//缴纳时间
            }
            this.payDepositRemark = row.payDepositRemark;// 缴纳备注信息
            ...
            this.$axios({
                ...
                if(res.data.status == 200){
                    ...
                    this.subpackageData.forEach(item=>{
                        ...
                        this.tenderPurchaserName =  item.projectInformationVo.tenderPurchaserName;
                ...
                if(res.data.status == 200){
                    ...
                    this.itemsList.forEach(item=>{
                        if(this.projectObj.totalProjectId == item.entrySubcontractNumber || this.projectObj.totalProjectId == item.projectCode){
                            ...
                            this.technologyQualifications=item.technologyQualifications;// 简要规格描述或项目基本情况
            ...
            this.$axios({
				...
				if(res.data.status == 200){
                    ...
                    this.bidsignData.forEach(item=>{
                        ...
                        if(item.isPayDeposit == null || item.isPayDeposit == 0 || item.isPayDeposit == '未缴纳'){
