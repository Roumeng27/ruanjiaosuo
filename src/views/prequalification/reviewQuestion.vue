<template>
    ...
    <div class="newBox">
        ...
        <div class="wrapper">
            <div class="box">
                <button class="btn" @click="newManage">新增资审澄清</button>
            ...
            <div class="nextWrapperBox">
                ...
                <div class="main_info">
                    <el-collapse v-model="activeName" accordion>
                        ...
                        <!-- 资审澄清文件附件 -->
                        <el-collapse-item title="资审澄清文件附件" name="2">
                           <el-table :data="manageDate" stripe style="width: 100%">
                                <el-table-column  prop="step"  label="附件名称">
                                </el-table-column>
                                <el-table-column  prop="handlingPersonnel"  label="附件列表(点击查看)">
                                </el-table-column>
                            </el-table>
                        </el-collapse-item>
                        <!-- 澄清与修改内容 -->
                        <el-collapse-item title="澄清与修改内容" name="3">
                            <div class="edit_list">
                                <div class="editItem">
                                    <div class="editCenter">
                                ...
                                <div class="editItem">
                                    <div class="editCenter">
                                        <div class="editName">澄清与修改的内容：</div>
                                        <div class="editContent">{{}} </div>
                                    </div>
                                </div>
                            </div>
...
export default {
	...
	methods:{
        ...
        // 查看资审澄清文件列表
        lookOver(row){
            this.nextFlag = true;// 查看资审澄清文件详情
            this.headerBtn = true;// 按钮隐藏
        },
        //新增澄清文件
		newManage(){
			this.addFlag = true;// 新增澄清文件 挑选项目
        ...
        sureChoise(){
            ...
            this.newFlag = true;// 资审澄清文件 保存和下一步
        },
        // 挑选项目操作
		getDetail(row){
