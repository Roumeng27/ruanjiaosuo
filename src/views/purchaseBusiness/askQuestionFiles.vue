                            ...
                            <div class="edit_list">
                                ...
                                <div class="editItem">
                                    ...
                                    <div class="editCenter">
                                        ...
                                        <div class="editContent">
                                            <el-input  id="focus2" v-model="questionPersonName" clearable></el-input>
                                        </div>
                                    </div>
                                </div>
                                <div class="editItem">
                                    <div class="editCenter">
                                        ...
                                        <div class="editContent">
                                            <el-input id="focus3"  v-model="questionPersonPhone" clearable></el-input>
                                        </div>
                                    </div>
                                    <div class="editCenter">
                                        <div class="editName"><p class="star">*</p>手机：</div>
                                        <div class="editContent">
                                            <el-input id="focus4"  v-model="questionPersonTelephone" clearable></el-input>
                                        </div>
                                    </div>
                                </div>
                            </div>
