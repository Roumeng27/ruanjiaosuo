                    ...
                    <el-collapse v-model="activeName" accordion>
                        ...
                        <el-collapse-item title="成交信息" name="4" v-show="!diffFlag">
                            <div class="edit_list">
                                ...
                                <div class="editItem">
                                    <div class="editCenter">
                                        <div class="editName">简要规格描述/项目基本情况：</div>
                        ...
                        <el-collapse-item title="公告内容" name="5">
                            <div class="edit_list">
                                ...
                                <div v-if="biddingOrganization == '委托招标'">
                                    ...
                                    <div class="editItem">
                                        <div class="editCenter">
                                            <div class="editName"style="width:170px;">招标(采购)代理机构全称：</div>
                                            <div class="editContent">{{biddingPurchasingAgencyName}}</div>
                                        </div>
                                    </div>
                                    <div class="editItem">
                                        <div class="editCenter">
                                            <div class="editName"style="width:170px;">招标(采购)代理机构地址：</div>
    ...
    export default {
        data(){
            return {
                ...
                saveTime:'',// 保存时间
                //成交候选人
                technologyQualifications:'',// 简要规格描述/项目基本情况
                personnels:'',
                purchaseAmount:'',// 采购数量
                        ...
                        if(res.data.data.length>0){
                            if(res.data.data[0].items.length >0){
                                res.data.data[0].items.forEach(item=>{
                                    this.technologyQualifications=item.technologyQualifications;// 简要规格描述/项目基本情况
