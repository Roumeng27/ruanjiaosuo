                            ...
                            <div class="table_box">
                                <el-table :data="subpackageData" stripe style="width: 100%">
                                    ...
                                    <el-table-column label="采购内容">
                                        <template slot-scope="scope">
                                            <i class="el-icon-search"  style="cursor: pointer;" @click="nextDetail(scope.row)"></i>
                                        </template>
                                    </el-table-column>
                                </el-table>
                            </div>
    ...
    export default {
        data(){
            return {
                ...
                order:true,// 场地预约
                accessory:false,// 附件
                submissionDocumentsPlace:'',//递交响应文件地点
                assessmentTime:'',//开启时间
                bidOpeningPlace:'',//响应文件开启地点
                bidEvaluationStandard:'',//评标办法
                remark:'',
                projectLeader:'',
                projectLeaderPhone:'',
                ...
                applicantQualifications:'',// 供应商资格条件
        ...
        created(){
            ...
            this.getTwoList();// 采购信息附件
            this.getOpenTime();// 通过场地预约获取响应文件开启时间
        ...
        methods: {
            ...
            // 下一步采购内容详情
            nextDetail(row){
                console.log(row.entrySubcontractNumber)
                this.entrySubcontractNumber = row.entrySubcontractNumber;// 入场项目分包编号
                this.subcontractName = row.subcontractName;// 分包名称
                this.subcontractingControlAmount = row.subcontractingControlAmount;// 分包控制金额
            ...
            getpageInfo(){
                return this.$axios({
                    ...
                    if(res.data.status == 200){
                        ...
                        this.bidOpeningPlace= res.data.data.bidOpeningPlace;// 响应文件开启地点 
                        // 招标工本费
                        ...
                        this.areaList.forEach(area=>{
                           if(area.entrySubcontractNumber == this.entrySubcontractNumber){
                                ...
                                this.technologyQualifications=area.technologyQualifications;// 技术/服务要求
