                    ...
                    <el-collapse v-model="activeName" accordion>
                        ...
                        <el-collapse-item title="公示内容" name="5">
                            <div class="edit_list">
                                ...
                                <div class="editItem">
                                    <div class="editCenter">
                                        <div class="editName" style="width:180px;">中标人（成交供应商）全称：</div>
                                ...
                                <div class="editItem">
                                    <div class="editCenter">
                                        <div class="editName" style="width:180px;">中标人（成交供应商）地址：</div>
                                        <div class="editContent">
                                ...
                                <div class="editItem">
                                    <div class="editCenter">
                                        <div class="editName" style="width:200px;">中标人（成交供应商）联系方式：</div>
                                        <div class="editContent">
