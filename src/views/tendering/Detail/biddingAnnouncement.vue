    ...
    <div class="newBox" style="overflow-y:hidden;height:100%;">
        ...
        <el-dialog
            ...
            <div class="icon">
                ...
                <span>招标文件发售时间距开标时间不足20日,请确认！</span>
            </div>
            <span slot="footer" class="dialog-footer">
        ...
        <el-dialog
            ...
            <div class="icon">
                <i class="el-icon-warning"></i>
                <span>招标文件发售时间距招标文件发售截止时间不足5日,请确认！</span>
            </div>
            <span slot="footer" class="dialog-footer">
                <el-button type="primary" @click="handleClose()">确 定</el-button>
            </span>
        ...
        <el-dialog
            ...
            <div class="icon">
                <i class="el-icon-warning"></i>
                <span>招标文件发售时间距招标文件发售截止时间不足5日,并且招标文件发售时间距开标时间不足20日,请确认！</span>
            </div>
            <span slot="footer" class="dialog-footer">
                <el-button type="primary" @click="handleClose()">确 定</el-button>
            </span>
                            ...
                            //如果上一步打钩，进一步判断
                                ...
                                if(obj.zhaobiao.state == '办理通过'&& obj.houxuanren.state == '办理通过'){
                                    ...
                                    if(obj.zhaobiao.state == '办理通过'){
                                        ...
                                        this.alertMsg = '尚未完成场地预约,无法进行招标公告!'
                                    }
                                }
                            }else{
                                //其他的都不能看
