                            ...
                            <div class="edit_list">
                                ...
                                <div class="editItem">
                                    <div class="editTextarea">
                                        ...
                                        <div class="editContent">
                                            <el-input v-model="tendereePhone" id="focus14" clearable></el-input>
                                        </div>
                                    </div>
                                </div>
                                <div  v-if="role_types == '招标(采购)代理' || str_entrust_type != '委托角色'">
                                    ...
                                    <div class="editItem">
                                        <div class="editTextarea">
                                            <div class="editName">联系方式：</div>
                                            <div class="editContent">
                                                <el-input v-model="agentPhone" id="focus16" clearable></el-input>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="edit_list">
                                ...
                                <div class="editItem">
                                    <div class="editTextarea">
                                        ...
                                        <div class="editContent">
                                            <el-input id="focus4"  v-model="changesAs" type="textarea" clearable></el-input>
                                        </div>
                                    </div>
                                </div>
                                <!-- 是否变更投标事宜 -->
                                ...
                                <div  v-show="isTenderShow">
                                    ...
                                    <div class="editItem">
                                        <div class="editCenter">
                                            <div class="editTit"><span style="color:#f00;">*</span>招标文件发售时间：</div>
                                            <div class="editContent">
                                                <el-date-picker id="focus8"  :picker-options="pickerOptions0" clearable  v-model="collectTime" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
                                                </el-date-picker>
                                            </div>
                                        </div>
                                        <div class="editCenter">
                                    ...
                                    <div class="editItem">
                                        <div class="editCenter">
                                            <div class="editName"><span style="color:#f00;">*</span>招标文件工本费：</div>
                                            <div class="editContent">
                                                <p>人民币</p>
                                    ...
                                    <div class="editItem">
                                        <div class="editTextarea">
                                            <div class="editName"><span style="color:#f00;">*</span>投标人需提交资料：</div>
                                            <div class="editContent">
                                                <el-input v-model="bidderData"  id="focus10"  type="textarea"  clearable :rows="3"></el-input>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="editItem">
                                    <div class="editTextarea">
                                        ...
                                        <div class="editContent">
                                            <el-radio-group id="focus11"  v-model="isChangeBidOpenMatters" @change="changeTender()">
                                                <el-radio label="是">是</el-radio>
                                                <el-radio label="否">否</el-radio>
                                            </el-radio-group>
                                        </div>
                                ...
                                <div v-show="OpenTenderShow">
                                    ...
                                    <div class="editItem">
                                        <div class="editCenter">
                                            ...
                                            <div class="editContent">
                                                <el-select id="focus12"  v-model="openingRoom" placeholder="请选择">
                                    ...
                                    <div class="editItem">
                                        <div class="editCenter">
                                            ...
                                            <div class="editContent">
                                                <el-select id="focus13"  v-model="bidEvaluationRoom" placeholder="请选择">
                                    ...
                                    <div class="editItem">
                                        ...
                                        <div class="editCenter">
                                            <div class="editName">联系方式：</div>
                                            <div class="editContent">
                                                <el-input v-model="projectLeaderPhone" id="focus15" clearable></el-input>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="editItem">
                        ...
                        <el-collapse-item title="公告信息" name="3">
                            <div class="edit_list">
                                ...
                                <div  v-show="isTenderShow">
                                    ...
                                    <div class="editItem">
                                        <div class="editCenter">
                                            <div class="editTit">招标文件发售时间：</div>
                                            <div class="editContent">
...
export default {
  ...
  methods:{
        ...
        getInitInfo(){
            ...
            return this.$axios({
                ...
                if(res.data.status == 200){
                    ...
                    this.creatorCompanyName = res.data.data[0].creatorCompanyName;
                    // 7.29
                        ...
                        res.data.data.forEach(item=>{
                            if(window.sessionStorage.str_entrust_type != '委托角色' && this.role_types == '招标(采购)人'){
                                ...
                                if(item.bidEvaluationTime == null || item.bidEvaluationTime == 0 || item.bidEvaluationTime == ""){
                                    ...
                                    this.bidEvaluationTime = dayjs(item.bidEvaluationTime).format('YYYY-MM-DD HH:mm:ss');
                                }
                            }else{
                                if(item.changesDate == null || item.changesDate == 0 || item.changesDate == ""){
                                    this.changesDate = ""
        ...
        newly(num){
            ...
            }else if(this.isChangeBidOpenMatters == "是"){
                if(!this.openingRoom){
                    $('#focus12').focus();
                    ...
                    if(num == 1){
                        ...
                        if(res.data.data.times == 0){
                            if(res.data.data.openingTime == null){
                                ...
                                this.assessmentTime = dayjs(res.data.data.openingTime).format('YYYY-MM-DD');
                            }
                        }else{
        ...
        getlastTemp(){
            ...
            this.$axios({
                ...
                if(res.data.status == 200){
                    ...
                    if(res.data.data[0].bidEvaluationTime == null || res.data.data[0].bidEvaluationTime == 0 || res.data.data[0].bidEvaluationTime == ""){
                        this.bidEvaluationTime = ""
                    }else{
                        ...
                        //如果上一步打钩，进一步判断
                            ...
                            if(obj.zhaobiao.state == '办理通过'&& obj.houxuanren.state == '办理通过'){
                                ...
                                if(obj.zhaobiao.state == '办理通过'){
                                    ...
                                    this.alertMsg = '尚未完成招标公告,无法进行变更公告!'
                                }
                            }
                        }else{
                            //其他的都不能看
