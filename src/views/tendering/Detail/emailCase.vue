            ...
            <div v-show="writeFlag" class="backTop" style="height:100%;overflow-y:hidden;min-width:1200px;overflow-x:scroll;">
                ...
                <div class="new_main" style="height:99%;overflow-y:scroll;">
                    <el-collapse v-model="activeName" accordion>
                        ...
                        <!-- 招标项目 -->
                        <el-collapse-item title="招标项目" name="2">
                        ...
                        <!-- 招标公告 -->
                        <el-collapse-item title="招标公告" name="3">
                        ...
                        <!-- 招标文件 -->
                        <el-collapse-item title="招标文件" name="4">
                        ...
                        <!-- 中标结果公告 -->
                        <el-collapse-item title="中标结果公告" name="5">
                        ...
                        <!-- 招标控制价文件 -->
                        <el-collapse-item title="招标控制价文件" name="6">
                        ...
                        <!-- 招标人评委 -->
                        <el-collapse-item title="招标人评委" name="7">
                        ...
                        <!-- 招标异常 -->
                        <el-collapse-item title="招标异常" name="8">
                        ...
                        <!-- 需说明的事项 -->
                        <el-collapse-item title="需说明的事项" name="9">
                            <div>
            ...
            <div v-show="nextFlag" class="backTop" style="height:100%;overflow-y:hidden;min-width:1200px;overflow-x:scroll;">
                ...
                <div class="new_main" style="height:99%;overflow-y:scroll;">
                    <el-collapse v-model="activeName1" accordion>
                        ...
                        <!-- 相关附件 -->
                        <el-collapse-item title="相关附件" name="10">
                        ...
                        <!-- 办理记录 -->
						<el-collapse-item title="办理记录" name="11">
    ...
    methods: {
        ...
        openFile(num){
            ...
            if(this.num == 1){
                ...
                this.uploadTitle = '招标项目相关附件'
			}else if(this.num == 6){
                this.uploadTitle = '招标（采购）人确认函'
			}else if(this.num == 7){
                this.uploadTitle = '招标公告'
			}else if(this.num == 8){
            ...
            if(this.num == 8){
                if(this.documentsData[0].attachlist.length > 0){
                    ...
                    if(this.projectObj.totalProjectId.indexOf("-") != -1 && this.projectObj.totalProjectId!=null){
                        ...
                        if(this.num == 1){
                            formData.append("fileType", '招标人身份证明');
                        ...
                        //如果上一步打钩，进一步判断
                            ...
                            if(obj.zhaobiao.state == '办理通过'&& obj.dangan.state == '办理通过'){
                                ...
                                if(obj.zhaobiao.state == '办理通过'){
                                    ...
                                    this.alertMsg = '尚未发中标结果公告，无法备案电子档案!'
                                }
                            }
                        }else{
                            //其他的都不能看
