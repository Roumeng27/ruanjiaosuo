        ...
        <div v-show="passJudgeShow" style="height:100%;overflow-y:scroll;">
                            ...
                            <div class="edit_list">
                                ...
                                <div class="editItem">
                                    ...
                                    <div class="editCenter">
                                        <div class="editName">联系方式：</div>
                                        <div class="editContent">
                                            <el-input v-model="leaderContactInformation" id="focus6" clearable  ></el-input>
                                        </div>
                                    </div>
                                </div>
                                <div class="editItem">
                                ...
                                <div class="editItem">
                                    <div class="editCenter">
                                        ...
                                        <div class="editContent">
                                            ...
                                            <el-input id="focus2"  v-model="winningAmountLowercase" clearable @blur ='inputblur'></el-input>
            ...
            <div class="nextWrapper" v-show="showFlag"> 
                ...
                <div class="main_info">
                    <el-collapse v-model="activeName" accordion>
                        ...
                        <!-- 中标信息 总包-->
                        <el-collapse-item title="中标信息" name="4" v-show="!diffFlag">
                            <div class="edit_list">
                                <div class="editItem">
                                    <div class="editCenter">
                                        <div class="editName">招标项目名称：</div>
                        ...
                        <el-collapse-item title="公告内容" name="5">
                            <div class="edit_list">
                                ...
                                <div  v-if="role_types == '招标(采购)代理' || str_entrust_type != '委托角色'">
                                    ...
                                    <div class="editItem">
                                        <div class="editCenter">
                                            <div class="editName"  style="width:187px;">招标(采购)代理机构联系方式：</div>
                ...
                <div class="searchBox">
                    ...
                    <div class="search_main">
                        <el-table
                            ...
                            <el-table-column
                                label="招标项目名称" :show-overflow-tooltip ="true">
                            ...
                            <el-table-column
                                label="招标方式" :show-overflow-tooltip ="true">
                            ...
                            <el-collapse-item title="中标信息" name="2">
                                <div class="edit_list">
                                    ...
                                    <div class="editItem">
                                        <div class="editCenter">
                                            <div class="editName">单价：</div>
                                            <div class="editContent">
                                                <el-input v-model="unitPrice" id="focus10" clearable></el-input>
                                            </div>
                                        </div>
                                        <div class="editCenter">
                                            <div class="editName">数量：</div>
                                            <div class="editContent">
                                                <el-input v-model="number" id="focus11" clearable></el-input>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="editItem">
                                ...
                                <div class="editItem">
                                        <div class="editTextarea">
                                            <div class="editName"><p class="star">*</p>中标单位名称：</div>
                                            <div class="editContent">
                                            <el-input id="focus8" v-model="nameOfSuccessfulSupplier" readonly></el-input>
                                            </div>
                                            <el-button plain @click="pickInfo">检索</el-button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="editItem">
                                        <div class="editCenter">
                                            ...
                                            <div class="editContent">
                                                <p style="color:#6e622e;">人民币</p>
                                                <el-input id="focus9"  v-model="winningAmountLowercase" clearable @blur ='inputblur'></el-input>
                                                <p style="color:#6e622e;">元</p>
                                            </div>
                                        </div>
                                        <div class="editCenter" >
            ...
            <el-dialog
                ...
                <div class="icon">
                    ...
                    <span>存在未添加中标信息的分包,请添加中标信息后提交!</span>
                </div>
                <span slot="footer" class="dialog-footer">
...
export default {
    data(){
        return {
            ...
            totalProjectId:'',
            searchwinFlag:false,// 查看中标信息 分包 弹窗
            // 办理记录
            manageDate:[],
            creationTime:'',// 时间
            candidateMenuItem:[],
            ...
            active_obj:{},//点击笔记录的对象
            save_obj:{},//点击保存记录的对象
            winnResultItemId:'',// 中标信息ID
            tempList:[],// 保存分包的中标信息的数组
        }
    },
    created(){
        ...
        newly(num){
            if(!this.diffFlag){
                ...
                if(this.unitPrice != "" && this.unitPrice != null && !checkNumber(this.unitPrice)){
                    ...
                    $('#focus1').focus();
                    this.$message.warning('请输入中标单位名称!');
                    return false;
                }else if(!this.winningAmountLowercase){
                    $('#focus2').focus();
                    this.$message.warning('请输入正确的中标金额!');
                    return false;
                ...
                if(this.tendereeContactInformation != "" && this.tendereeContactInformation != null && !isPoneAvailable(this.tendereeContactInformation) && !checkPhone(this.tendereeContactInformation)){
                    $('#focus5').focus();
                    this.$message.warning('中标信息联系方式请输入正确!');
                    return false;
                }else if(this.leaderContactInformation != "" && this.leaderContactInformation != null && !isPoneAvailable(this.leaderContactInformation) && !checkPhone(this.leaderContactInformation)){
                    $('#focus6').focus();
                    this.$message.warning('中标信息联系方式请输入正确!');
                   ...
                   if(arr.length != 0){
                    ...
                    arrList.forEach(item=>{
                        if(!item.contractPerformancePeriod){
                            this.warnFlag = true;
                            flag = false;
                            return false;
                        }else if(!item.contractPerformanceEnd){
                            this.warnFlag = true;
                            flag = false;
                            return false;
                        }else if(!item.nameOfSuccessfulSupplier){
                            this.warnFlag = true;
                            flag = false;
                            return false;
		...
		winItem(row){
            ...
            this.areaList.forEach(area=>{
                if(row.entrySubcontractNumber == area.entrySubcontractNumber){
                    flag = false;
                    areaItem = area;
                    this.winnResultItemId= area.winnResultItemId;// 中标信息ID
                }
            })
            if(flag){
                this.winnResultItemId= areaItem.winnResultItemId;// 中标信息ID
            }
            ...
            if(this.winnResultItemId == undefined || this.winnResultItemId == ''){
                this.mainWinningBid='';// 主要中标标的
                this.unitPrice='';// 单价
                this.number='';// 数量
                this.specificationType='';// 规格型号
                this.contractPerformancePeriod='';// 合同履行期开始
                this.contractPerformanceEnd='';// 合同履行期结束
                this.nameOfSuccessfulSupplier='';// 中标供应商名称
                this.addressOfSuccessfulSupplier='';//中标供应商地址
                this.winningAmountLowercase='';// 中标金额小写
                this.winningAmountCapitalization='';// 中标金额大写
                this.idOfSuccessfulSupplier = '';
            }else{
                this.searchwinArea();// 查看中标信息详情
            }
        },
        // 查看中标信息详情
        searchwinArea(){
            this.$axios({
                ...
                if(res.data.status == 200){
                    this.mainWinningBid=res.data.data.mainWinningBid;// 主要中标标的
                    ...
                    this.nameOfSuccessfulSupplier=res.data.data.nameOfSuccessfulSupplier;// 中标供应商名称
                    this.addressOfSuccessfulSupplier=res.data.data.addressOfSuccessfulSupplier;//中标供应商地址
                    this.winningAmountLowercase=res.data.data.winningAmountLowercase;// 中标金额小写
                    this.winningAmountCapitalization=res.data.data.winningAmountCapitalization;// 中标金额大写
                    this.idOfSuccessfulSupplier = res.data.data.idOfSuccessfulSupplier;//中标供应商ID;
                }else{
                    this.$message.warning(res.data.msg);
                }
            }).catch(err=>{
                ...
                if(res.data.status == 200){
                    if(res.data.data.length>0){
                        ...
                        if(res.data.data[0].updateTime !=null){
                                this.updateTime = formatDate(res.data.data[0].updateTime);// 招标公告日期
                            }else{
                                this.updateTime = ""
                            }
                        ...
                        //如果上一步打钩，进一步判断
                            ...
                            if(obj.zhaobiao.state == '办理通过'&& obj.gonggao.state == '办理通过'){
                                ...
                                if(obj.zhaobiao.state == '办理通过'){
                                    ...
                                    this.alertMsg = '尚未完成招标文件，无法进行中标结果公告操作!'
                                }
                            }
                        }else{
                            //其他的都不能看
