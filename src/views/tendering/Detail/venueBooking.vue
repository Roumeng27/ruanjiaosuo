                            ...
                            <div class="edit_lis">
                                ...
                                <div class="editItem">
                                    <div class="editCenter">
                                        ...
                                        <div class="editContent">
                                            <el-date-picker @blur="judgeTime()" id="focus1" value-format="timestamp" v-model="assessmentTime" type="datetime" :picker-options="pickerOptions0"  placeholder="选择日期时间"  @change="blurDate()">
                                            </el-date-picker>
                                        </div>
                                    </div>
                                    <div class="editCenter">
                        ...
                        if(window.sessionStorage.str_entrust_type != '委托角色' && this.role_types != '招标(采购)代理'){
                            ...
                            //如果上一步打钩，进一步判断
                                ...
                                if(obj.zhaobiao.state == '办理通过'){
                                    ...
                                    this.alertMsg = '尚未完成项目入场登记,无法进行招场地预约!'
                                }
                            } 
