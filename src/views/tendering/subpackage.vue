                            ...
                            <div class="edit_list">
                                    ...
                                    <div class="editCenter">
                                        ...
                                        <div class="editContent" style="display:flex;justify-content:flex-start;">
                                            <el-button plain>挑选分包</el-button>
                                             <b style="color:#f00;">说明：若当前分包是由于招标异常产生的，请点击挑选分包；否则，请勿点击，直接填写即可</b>
                                        </div>
                                    </div>
                                </div> -->
                                <div class="editItem">
                                 ...
                                 <div class="editItem">
                                    <div class="editCenter">
                                        ...
                                        <div class="editContent">
                                            <el-input id="focus3"  v-model="scopeOfTender" clearable></el-input>
                                        </div>
                                       <div style="width:50px;"></div>
                                    </div>
                                </div>
                                <div class="editItem">
                                    <div class="editCenter">
                                        ...
                                        <div class="editContent">
                                            <el-input id="focus4"  v-model="subcontractingControlAmount" clearable></el-input>
                                            <p>万元</p>
                                        </div>
                                    </div>
                                    <div class="editCenter">
                                        ...
                                        <div class="editContent">
                                            <el-select id="focus5"   v-model="qualificationExaminationMethod" clearable placeholder="请选择" @change="currentSel">
